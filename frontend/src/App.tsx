...
import { SteamAnalysisForm } from './components/Analysis/SteamAnalysisForm';
...
export type ViewType = 'overview' | 'analysis' | 'steam-analysis' | 'reports' | 'market' | 'data';
...
function App() {
  ...
  const renderView = () => {
    switch (currentView) {
      ...
      case 'steam-analysis': return <SteamAnalysisForm />;
